(function(){
  ...
  window.addEventListener('load', function(e) {
    ...
    input_numero_entradas.addEventListener('input', function(e) {
      numero_entradas = Number(e.target.value);
    });

    // Resta entradas
    restarEntrada.addEventListener('click', function(e) {
    ...
    // Suma entradas
    sumarEntrada.addEventListener('click', function(e) {
      if(numero_entradas >= 0){
        numero_entradas++;
        input_numero_entradas.value = numero_entradas;
      }
    ...
    form_comprar_entradas.addEventListener('submit', function(e) {
