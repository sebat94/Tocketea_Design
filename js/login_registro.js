(function(){
  ...
  window.addEventListener('load', function() {
      ...
      btn_mover_a_login.addEventListener('click', function(){
        irLoginBigScreen();
      });
      btn_mover_a_registro.addEventListener('click', function(){
        irRegistroBigScreen();
      });
      // Para navegar entre login / reistro en Tablet & MVL
      btn_mover_a_login2.addEventListener('click', function(){
        irLoginSmallScreen();
      });
      btn_mover_a_registro2.addEventListener('click', function(){
